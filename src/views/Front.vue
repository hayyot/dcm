  ...
  <div>
    ...
    <div class="front-header">
      <div class="front-header-left" @click="navTo('/front/home')">
        ...
        <div class="title">DIY电脑配制推荐系统</div>
      </div>
      <div class="front-header-center">
        <div class="front-header-nav">
          <el-menu :default-active="$route.path" mode="horizontal" router>
            <el-menu-item index="/front/home">硬件库</el-menu-item>
            <el-menu-item index="/front/person">个人中心</el-menu-item>
            <el-menu-item index="/front/diy">DIY</el-menu-item>
            <el-menu-item index="/front/tianti">天梯图</el-menu-item>
            <el-menu-item index="/front/blog">装机必备</el-menu-item>
          </el-menu>
        </div>
      </div>
