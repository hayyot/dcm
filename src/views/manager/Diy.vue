    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" ref="formRef">
        <el-form-item prop="title" label="类型">
          <el-input v-model="recommend.category" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="content" label="名称">
          <el-input v-model="recommend.name" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="title" label="数量">
          <el-input v-model="recommend.num" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="content" label="价格">
          <el-input v-model="recommend.price" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
