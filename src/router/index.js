...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'category', name: 'Category', meta: { name: '板块分类' }, component: () => import('../views/manager/Category') },
      { path: 'blog', name: 'Blog', meta: { name: '内容信息' }, component: () => import('../views/manager/Blog') },
      { path: 'comment2', name: 'Comment2', meta: { name: '帖子评论信息' }, component: () => import('../views/manager/Comment2') },
      {
        path: 'diy',
        name: 'diy',
        meta: { name: 'diy' },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'blog', name: 'Blog', meta: { name: '装机必备' }, component: () => import('../views/front/Blog') },
      { path: 'blogDetail', name: 'BlogDetail', meta: { name: '内容详细页' }, component: () => import('../views/front/BlogDetail') },
      { path: 'diy',name: 'diy', meta: { name: 'diy' },component: () => import('../views/front/Diy.vue')},
      { path: 'tianti',name: 'tianti', meta: { name: 'tianti' },component: () => import('../views/front/Tianti.vue')}
    ]
  },
